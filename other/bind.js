...
// 2. Const newFn = fn.bind(context,arg1,arg2,..)：本质就是将fn方法添加到conetxt的属性中，所以fn中的this就指向 context；即 context.fn()
//     1. context：当函数被调用时，该参数会作为原函数运行时的this指向；
...
// 4. 实际上bind里面使用的apply除了转移this的指向，也进行了构造函数继承的操作